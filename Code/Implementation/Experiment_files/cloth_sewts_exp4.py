...
class Cloth(base.Task):
  ...
  def action_spec(self, physics):
    ...
    # CORNER AND ITS NEIGHBOURS ACTION [x,y,z] 3*4 = 12
  ...
  def get_observation(self, physics):
    ...
    else if self._random_location == 1:
        if np.random.choice(2) == 0:
    ...
    else if self._random_location == 2:
        if np.random.choice(2) == 0:
    ...
    else if self._random_location == 3:
        if np.random.choice(2) == 0:
            current_pos_G0_0 = physics.named.data.geo_xpos['G8_8']
    ...
    obs.append(current_pos_G0_1.reshape(-1).astype('float32'))
    obs.append(current_pos_G0_2.reshape(-1).astype('float32'))
    obs.append(current_pos_G0_3.reshape(-1).astype('float32'))
    print(obs)
    return obs
