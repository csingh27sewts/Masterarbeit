...
from Packages.ActorCriticPapertoCode.SAC.sac_torch import Agent
from Packages.ActorCriticPapertoCode.SAC.utils import plot_learning_curve
...
#                "Sampled_Action" : [],
    ...
    for i in range(n_games):
        ...
        while done is False : 
            ...
            print(action,"/n")
            # print(observation,"/n")
            action_fed = np.array([action[0][0], action[0][1]]) #cloth_corner
