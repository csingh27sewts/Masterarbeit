...
INDEX_ACTION=['B0_0','B0_1','B0_2','B0_3','B0_4','B0_5','B1_0','B2_0','B3_0','B4_0','B5_0','B1_1','B1_2','B1_3','B1_4','B1_5','B2_1','B2_2','B2_3','B2_4','B2_5','B3_1','B3_2','B3_3','B3_4','B3_5',
        'B4_1','B4_2','B4_3','B4_4','B4_5','B5_1','B5_2','B5_3','B5_4','B5_5']

def get_model_and_assets():
  """Returns a tuple containing the model XML string and a dict of assets."""

  return common.read_model('cloth_sewts_medium_raw.xml'),common.ASSETS
...
class Cloth(base.Task):
  ...
  def get_observation(self, physics):
    ...
    a_z = physics.named.data.geom_xpos['G0_0'][2]
    b = physics.named.data.geom_xpos['G0_1']
    b_z = physics.named.data.geom_xpos['G0_1'][2]
    c = physics.named.data.geom_xpos['G0_2']
    c_z = physics.named.data.geom_xpos['G0_2'][2]
    obs_ = np.array ([a_z,b_z,c_z])
