...
class Cloth(base.Task):
    ...
    def action_spec(self, physics):
        ...
        # X,Y,Z for the 4 corners perhaps
    ...
    def initialize_episode(self, physics):
        ...
        # Applied cartesian force / torque of size 6. B3_4 and B3_5 represent the bodies on which forces are applies. 
        # :3 shows that only forces and not torques are applied
