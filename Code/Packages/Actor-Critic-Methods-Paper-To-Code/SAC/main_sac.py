...
if __name__ == '__main__':
    ...
    for i in range(n_games):
        ...
        # observation is a 4 tuple
        # (o1, o2, o3, o4)
        # o1 = Position of cart -2.4 < x < 2.4
        # o2 = Cart velocity -inf < v < inf
        # o3 = Pole Angle -41.8 deg < theta < 42.8 deg (0.73 rad)
        # o4 = Pole velocity -inf < omega < inf
        done = False
        score = 0
        while not done:
