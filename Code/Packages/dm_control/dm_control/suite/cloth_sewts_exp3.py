...
class Cloth(base.Task):
  ...
  def get_observation(self, physics):
    ...
    if self._random_location == 0:
        if np.random.choice(2) == 0:
            ...
            current_pos_G0_0 = physics.named.data.geom_xpos['G0_0']
            current_pos_G0_1 = physics.named.data.geom_xpos['G1_0']
            current_pos_G0_2 = physics.named.data.geom_xpos['G2_0']
            current_pos_G0_3 = physics.named.data.geom_xpos['G3_0']

    elif self._random_location == 1:
        if np.random.choice(2) == 0:
            current_pos_G0_0 = physics.named.data.geom_xpos['G6_8']
            current_pos_G0_1 = physics.named.data.geom_xpos['G6_8']
            current_pos_G0_2 = physics.named.data.geom_xpos['G7_8']
            current_pos_G0_3 = physics.named.data.geom_xpos['G8_8']
        elif np.random.choice(2) == 1:
            current_pos_G0_0 = physics.named.data.geom_xpos['G8_8']
            current_pos_G0_1 = physics.named.data.geom_xpos['G8_7']
            current_pos_G0_2 = physics.named.data.geom_xpos['G8_6']
            current_pos_G0_3 = physics.named.data.geom_xpos['G8_5']

    elif self._random_location == 2:
        if np.random.choice(2) == 0:
            current_pos_G0_0 = physics.named.data.geom_xpos['G8_0']
            current_pos_G0_1 = physics.named.data.geom_xpos['G8_1']
            current_pos_G0_2 = physics.named.data.geom_xpos['G8_2']
            current_pos_G0_3 = physics.named.data.geom_xpos['G8_3']
        elif np.random.choice(2) == 1:
            current_pos_G0_0 = physics.named.data.geom_xpos['G8_8']
            current_pos_G0_1 = physics.named.data.geom_xpos['G1_8']
            current_pos_G0_2 = physics.named.data.geom_xpos['G2_8']
            current_pos_G0_3 = physics.named.data.geom_xpos['G3_8']

    elif self._random_location == 3:
        if np.random.choice(2) == 0:
            current_pos_G0_0 = physics.named.data.geom_xpos['G8_8']
            current_pos_G0_1 = physics.named.data.geom_xpos['G7_8']
            current_pos_G0_2 = physics.named.data.geom_xpos['G6_8']
            current_pos_G0_3 = physics.named.data.geom_xpos['G5_8']
        elif np.random.choice(2) == 1:
            current_pos_G0_0 = physics.named.data.geom_xpos['G8_8']
            current_pos_G0_1 = physics.named.data.geom_xpos['G8_7']
            current_pos_G0_2 = physics.named.data.geom_xpos['G8_6']
    ...
    obs.append(current_pos_G0_0.reshape(-1).astype('float32'))
  ...
  def get_reward(self, physics):
    ...
    if self._random_location == 0:
        if np.random.choice(2) == 0:
            current_pos_G0_0 = physics.named.data.geo_xpos['G0_0']
            current_pos_G0_1 = physics.named.data.geo_xpos['G0_1']
            current_pos_G0_2 = physics.named.data.geo_xpos['G0_2']
            current_pos_G0_3 = physics.named.data.geo_xpos['G0_3']
        elif np.random.choice(2) == 1:
            current_pos_G0_0 = physics.named.data.geo_xpos['G0_0']
            current_pos_G0_1 = physics.named.data.geo_xpos['G1_0']
            current_pos_G0_2 = physics.named.data.geo_xpos['G2_0']
            current_pos_G0_3 = physics.named.data.geo_xpos['G3_0']

    elif self._random_location == 1:
        if np.random.choice(2) == 0:
            current_pos_G0_0 = physics.named.data.geo_xpos['G6_8']
            current_pos_G0_1 = physics.named.data.geo_xpos['G6_8']
            current_pos_G0_2 = physics.named.data.geo_xpos['G7_8']
            current_pos_G0_3 = physics.named.data.geo_xpos['G8_8']
        elif np.random.choice(2) == 1:
            current_pos_G0_0 = physics.named.data.geo_xpos['G8_8']
            current_pos_G0_1 = physics.named.data.geo_xpos['G8_7']
            current_pos_G0_2 = physics.named.data.geo_xpos['G8_6']
            current_pos_G0_3 = physics.named.data.geo_xpos['G8_5']

    elif self._random_location == 2:
        if np.random.choice(2) == 0:
            current_pos_G0_0 = physics.named.data.geo_xpos['G8_0']
            current_pos_G0_1 = physics.named.data.geo_xpos['G8_1']
            current_pos_G0_2 = physics.named.data.geo_xpos['G8_2']
            current_pos_G0_3 = physics.named.data.geo_xpos['G8_3']  
        elif np.random.choice(2) == 1:
            current_pos_G0_0 = physics.named.data.geo_xpos['G8_8']
            current_pos_G0_1 = physics.named.data.geo_xpos['G1_8']
            current_pos_G0_2 = physics.named.data.geo_xpos['G2_8']
            current_pos_G0_3 = physics.named.data.geo_xpos['G3_8']

    elif self._random_location == 3:
        if np.random.choice(2) == 0:
            current_pos_G0_0 = physics.named.data.geo_xpos['G8_8']
            current_pos_G0_1 = physics.named.data.geo_xpos['G7_8']
            current_pos_G0_2 = physics.named.data.geo_xpos['G6_8']
            current_pos_G0_3 = physics.named.data.geo_xpos['G5_8']
        elif np.random.choice(2) == 1:
            current_pos_G0_0 = physics.named.data.geo_xpos['G8_8']
            current_pos_G0_1 = physics.named.data.geo_xpos['G8_7']
            current_pos_G0_2 = physics.named.data.geo_xpos['G8_6']
