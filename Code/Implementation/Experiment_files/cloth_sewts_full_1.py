...
class Cloth(base.Task):
  ...
  def initialize_episode(self,physics):
    ...
    for i in range(0,50):
        physics.named.data.xfrc_applied[INDEX_ACTION,:2] = np.random.uniform(-1,1,size=2) * 5
        physics.step()
  ...
  def get_reward(self, physics):
    ...
    dist4 = np.sqrt(x_G00 ** 2 + (y_G00 - 0.09) ** 2 + z_G00 ** 2)
